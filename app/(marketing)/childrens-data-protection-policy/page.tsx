...
export const metadata = {
  ...
  description: "Learn how Fastlearners protects children’s personal data in compliance with NDPA 2023.",
};
    ...
    <div className="container mx-auto max-w-4xl px-4 py-10 sm:py-16 md:py-20 lg:py-24">
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            For the purpose of this policy, a “Child” or “Minor” refers to any individual under the age of <span className="font-bold text-foreground">18 years</span>.
          </p>
          <p className="leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">When a child uses the FastLearners Platform, we may collect the following categories of personal data:</p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Identification information: full name, username, and date of birth or age</li>
            <li>Educational information: class/grade level, subjects studied, quiz and test responses, academic progress, performance analytics, and learning activity logs</li>
            <li>Contact and account information: parent/guardian email address or phone number (required for consent and communication)</li>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            We only process a child’s personal data with <span className="font-bold text-foreground">verifiable parental or legal guardian consent</span>. This is a core requirement under the NDPA.
          </p>
          <p className="leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">Parents and legal guardians have full control over their child’s personal data. They may exercise the following rights at any time by contacting us:</p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Request access to the child’s personal data and obtain a copy</li>
            ...
            <li>Request portability of the child’s data (where technically feasible)</li>
          </ul>
          <p className="leading-relaxed text-muted-foreground">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            ...
            <li>Delivering personalised educational content and adaptive learning experiences</li>
            <li>Tracking academic progress and generating performance insights for the child and parent</li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Active accounts: data is retained for the duration the child actively uses the Platform.</li>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">We apply enhanced security safeguards to protect children’s personal data, including:</p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Encryption of data both in transit and at rest where technically feasible</li>
            <li>Strict role-based access controls so that only authorised personnel can access children’s data</li>
            <li>Regular security audits, vulnerability assessments, and penetration testing</li>
            <li>Staff training on handling children’s data and recognising risks</li>
