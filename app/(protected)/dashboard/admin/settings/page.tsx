...
export default function SettingsPage() {
  ...
  const canAccessAdminSettings = hasPermission('manage_platform') || userRole === 'admin';
  ...
  if (!canAccessAdminSettings) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>
          <strong>Access Restricted:</strong> Only administrators can access these settings.
        </AlertDescription>
      </Alert>
    );
  }
