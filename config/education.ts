...
export const subjects: Subject[] = [
  // Core subjects across multiple levels
  {
    ...
    color: '#3B82F6',
    compulsory: true,
    levels: ['pry1', 'pry2', 'pry3', 'pry4', 'pry5', 'pry6', 'jss1', 'jss2', 'jss3', 'sss1-science', 'sss1-arts', 'sss1-commercial', 'sss2-science', 'sss2-arts', 'sss2-commercial', 'sss3-science', 'sss3-arts', 'sss3-commercial']
  },
  {
    id: 'mathematics',
    name: 'Mathematics',
  ...
  // Primary Level Subjects
  {
    ...
    color: '#8B5CF6',
    compulsory: true,
    levels: ['pry1', 'pry2', 'pry3', 'pry4', 'pry5', 'pry6', 'jss1', 'jss2', 'jss3']
  },
  {
    id: 'social-studies',
    name: 'Social Studies',
  ...
  },
  {
    ...
    color: '#6366F1',
    compulsory: false,
    levels: ['jss1', 'jss2', 'jss3', 'sss1-science', 'sss2-science', 'sss3-science']
  },
...
export const gradingSystem: GradeBand[] = [
  ...
  { grade: 'B3', minScore: 65, maxScore: 69, description: 'Good', color: '#CA8A04' },
  { grade: 'C4', minScore: 60, maxScore: 64, description: 'Credit', color: '#D97706' },
  { grade: 'C5', minScore: 55, maxScore: 59, description: 'Credit', color: '#DC6D20' },
  { grade: 'C6', minScore: 50, maxScore: 54, description: 'Credit', color: '#EA580C' },
  { grade: 'D7', minScore: 45, maxScore: 49, description: 'Pass', color: '#F97316' },
  { grade: 'E8', minScore: 40, maxScore: 44, description: 'Pass', color: '#FB923C' },
  { grade: 'F9', minScore: 0, maxScore: 39, description: 'Fail', color: '#DC2626' }
];
 ...
 * Utility Functions
 */
export function getClassLevelsByStage(stage: 'primary' | 'jss' | 'sss'): ClassLevel[] {
...
export function getCompulsorySubjectsForClass(classLevelId: string): Subject[] {
  return subjects.filter(subject => 
    subject.levels.includes(classLevelId) && subject.compulsory
  );
}
...
export function getGradeFromScore(score: number): GradeBand {
  return gradingSystem.find(band => 
