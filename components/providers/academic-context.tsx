...
export function AcademicProvider({ 
  ...
  const [currentClass, setCurrentClassState] = useState<ClassLevel | null>(null);
  ...
  const availableSubjects = currentClass ? getSubjectsForClass(currentClass.id) : [];
...
export function useAcademicDisplay() {
  ...
  return {
    ...
    fullDisplay: currentClass && currentTerm 
