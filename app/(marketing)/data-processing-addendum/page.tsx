...
export const metadata = {
  ...
  description: "Data Processing Addendum for Schools, NGOs, Educational Partners and Institutions.",
};
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <div className="flex flex-col space-y-1 text-muted-foreground">
            ...
            <p>3 Chief Aaron Nteubong Street, Okorombokho, Eastern Obolo, Akwa Ibom State, Nigeria</p>
          </div>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            The Processor will process personal data solely on behalf of the Controller and in accordance with the terms of this DPA and the main service agreement. This DPA ensures compliance with the <span className="font-medium text-foreground">Nigeria Data Protection Act 2023 (NDPA)</span>, the <span className="font-medium text-foreground">General Application and Implementation Directive (GAID) 2025</span>, and other applicable data protection laws.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">The personal data processed under this DPA relates to the following categories of data subjects:</p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            ...
            <li>School administrators and other authorised staff of the Controller</li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">The Processor may process the following categories of personal data as instructed by the Controller:</p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Identification data (full names, usernames)</li>
            <li>Contact information (email addresses, phone numbers)</li>
            <li>Educational data (class/grade level, subjects, academic performance, quiz/test results, progress analytics, and learning activity logs)</li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            ...
            <li>Tracking and analysing academic progress and learning outcomes</li>
            <li>Generating reports and analytics for the Controller (e.g., class performance dashboards)</li>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              <span className="font-semibold text-foreground">b.</span> Ensure that all persons authorised to process the personal data are bound by confidentiality obligations and have received appropriate training on data protection.
            </p>
            <p>
              <span className="font-semibold text-foreground">c.</span> Implement and maintain appropriate technical and organisational security measures to protect the personal data against accidental or unlawful destruction, loss, alteration, unauthorised disclosure, or access. These measures shall take into account the state of the art, the costs of implementation, the nature, scope, context and purposes of processing, and the risk of varying likelihood and severity to the rights and freedoms of natural persons.
            </p>
            <p>
              <span className="font-semibold text-foreground">d.</span> Assist the Controller in fulfilling its obligations under the NDPA, including responding to data subject requests (access, rectification, erasure, restriction, portability, or objection), conducting Data Protection Impact Assessments (DPIA), and ensuring compliance with children’s data protection requirements.
            </p>
            <p>
              <span className="font-semibold text-foreground">e.</span> Notify the Controller without undue delay (and in any event within <span className="font-bold text-foreground">48 hours</span>) upon becoming aware of any personal data breach involving the Controller’s data. The notification shall include all relevant details required under the NDPA to enable the Controller to notify the NDPC and affected data subjects where necessary.
            </p>
            <p>
              <span className="font-semibold text-foreground">f.</span> Make available to the Controller all information necessary to demonstrate compliance with its obligations as a Processor and allow for audits or inspections (including on-site inspections where reasonably required) by the Controller or its appointed auditor. The Processor shall contribute to such audits at the Controller’s reasonable request.
            </p>
            <p>
              <span className="font-semibold text-foreground">g.</span> At the choice of the Controller, delete or return all personal data to the Controller upon termination or expiry of the services and delete existing copies unless applicable law requires storage of the personal data. Any remaining backups shall be securely purged within 90 days.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-2 text-muted-foreground">
            ...
            <ul className="list-disc space-y-1 pl-6">
              <li>Maintain an up-to-date list of sub-processors and make it available to the Controller upon request.</li>
              <li>Ensure that each sub-processor is bound by a written agreement that imposes the same data protection obligations as set out in this DPA.</li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>Standard Contractual Clauses (SCCs) approved by the NDPC or equivalent mechanisms</li>
