...
export const subjects: Subject[] = [
  ...
  },
  {
    ...
    name: "Geography",
    code: "GEO",
    description: "Study of physical features, climate, and human geography",
    icon: "globe",
    color: "#0D9488",
    compulsory: false,
    levels: [
  ...
  },
  {
    ...
    code: "RME",
    description: "Religious studies and moral values education",
    icon: "bookOpen",
    color: "#7C2D12",
    compulsory: false,
    levels: [
  ...
  },
  {
    ...
    name: "Efik",
    code: "EFK",
    description: "Efik language and literature",
    icon: "bookOpen",
    color: "#059669",
    compulsory: false,
    levels: [
  ...
  },
  {
    ...
    name: "Ibibio",
    code: "IBI",
    description: "Ibibio language and literature",
    icon: "bookOpen",
    color: "#059669",
    compulsory: false,
    levels: [
  ...
  },
  {
    ...
    name: "Obolo",
    code: "OBL",
    description: "Obolo language and literature",
    icon: "bookOpen",
    color: "#059669",
    compulsory: false,
    levels: [
  ...
  },
  {
    ...
    code: "TDR",
    description: "Technical drawing and engineering graphics",
    icon: "ruler",
    color: "#6366F1",
    compulsory: false,
    levels: [
...
export const apiSubjectIdToConfigIdMap: Record<number, string> = {
  ...
  1: "mathematics", // General Mathematics -> Mathematics
  2: "english", // English Language -> English Studies
  7: "mathematics", // Further Mathematics -> Mathematics
  9: "geography", // Geography -> Geography
  24: "religious-moral-education", // Religious and Moral Education -> Religious and Moral Education
  27: "yoruba", // Yoruba -> Yoruba
  28: "hausa", // Hausa -> Hausa
  29: "igbo", // Igbo -> Igbo
  30: "ibibio", // Ibibio -> Ibibio
  31: "efik", // Efik -> Efik
  32: "obolo", // Obolo -> Obolo
  35: "technical-drawing", // Technical Drawing -> Technical Drawing
};
