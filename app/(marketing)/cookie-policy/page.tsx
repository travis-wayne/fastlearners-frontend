...
export const metadata = {
  ...
  description:
    "Learn about how Fastlearners uses cookies and similar tracking technologies.",
};
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            FastLearners Limited (“FastLearners”, “we”, “us”, or “our”) uses
            cookies and similar tracking technologies (such as local storage,
            session storage, and device identifiers) on our website and mobile
            application to ensure the Platform functions properly, improve user
            experience, analyse performance, and provide personalised learning
            features.
          </p>
          <p className="leading-relaxed text-muted-foreground">
            This Cookie Policy explains what cookies and similar technologies we
            use, why we use them, and how you can manage or control them. It
          ...
          <p className="leading-relaxed text-muted-foreground">
            ...
            and relevant guidelines from the Nigeria Data Protection Commission
            (NDPC).
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            ...
            (computer, tablet, or mobile phone) when you visit our website or
            use our app. They help us remember your preferences and understand
          ...
          <div className="space-y-2">
            ...
            <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
              ...
              <li>
                SDKs and device identifiers (primarily for app functionality and
                security)
              </li>
            </ul>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground">
              These cookies are essential for the Platform to function correctly
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="text-muted-foreground">
              These improve usability and allow the Platform to remember your
              choices.
            </p>
            <div className="border-l-4 border-primary py-1 pl-4">
              <p className="mb-2 font-medium text-foreground">
              ...
              <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
                ...
                <li>
                  Remembering preferences (e.g., language, theme, or class
                  level)
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="leading-relaxed text-muted-foreground">
              Some cookies may be set by third-party service providers (e.g.,
              cloud hosting providers, analytics tools, or future payment
              gateways).
            </p>
            <p className="leading-relaxed text-muted-foreground">
              We ensure that all third parties we work with are bound by
              appropriate data protection agreements and comply with the NDPA.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
            <li>
              ...
              — for strictly necessary, functional, security, and performance
              cookies.
            </li>
            <li>
              <span className="font-medium text-foreground">Consent</span> — for
              non-essential cookies, particularly analytics and tracking
              cookies.
            </li>
          </ul>
          <p className="leading-relaxed text-muted-foreground">
            You can withdraw your consent for optional cookies at any time (see
            Section 6 below).
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            You have control over cookies and can manage them in the following
            ways:
          </p>
          <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
            <li>
              Through your browser or device settings (most browsers allow you
          ...
          <div className="rounded-lg border border-border bg-card p-4 shadow-sm">
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              Disabling strictly necessary cookies may prevent the Platform from
              functioning properly or limit your ability to use certain
              features.
            </p>
          </div>
          <p className="leading-relaxed text-muted-foreground">
            We may also provide a cookie consent banner or preference centre on
            the website to allow you to accept or reject categories of cookies.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            ...
            changes in our practices or legal requirements. Any material changes
            will be notified by updating the effective date and, where
            appropriate, through a prominent notice on the Platform. Your
