...
export const Icons = {
  ...
  logo: ({ ...props }: LucideProps) => (
    <svg
      ...
      {...props}
    >
      <path d="M111.577 0V29.634H63.5723L0 93.1807V53.9455C21.0754 32.8777 32.891 21.0669 53.9664 0H111.576H111.577Z" fill="currentColor" />
      <path d="M111.577 60.3081V89.9421H73.49L39.5637 123.854V181H9.91779V114.253L63.8842 60.3081H111.577Z" fill="currentColor" />
    </svg>
  ),
  media: Image,
