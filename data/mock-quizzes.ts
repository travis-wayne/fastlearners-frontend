...
export const mockQuizzes: Quiz[] = [
  {
    ...
    description:
      "Test your understanding of whole numbers and their properties",
    ...
    isAvailable: true,
    instructions:
      "Answer all questions. Each question carries 2 marks. You have 15 minutes to complete this quiz.",
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        explanation:
          "Whole numbers are non-negative integers starting from 0. -3 is negative, so it is not a whole number.",
        points: 2,
      },
      {
        id: "q2",
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          "Ascending order means from smallest to largest: 3, 8, 17, 25",
        points: 2,
      },
      {
        id: "q4",
        ...
        correctAnswer: "True",
        explanation:
          "Counting numbers (1, 2, 3, ...) are all whole numbers, but whole numbers also include 0.",
        points: 2,
      },
      {
        id: "q5",
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "Whole numbers continue infinitely, so there is no largest whole number.",
        points: 2,
      },
      {
        id: "q10",
  ...
  },
  {
    ...
    description:
      "Test your knowledge of English speech sounds and pronunciation",
    subjectId: "english",
    classLevel: "JSS1",
    term: "Term1",
    ...
    isAvailable: true,
    instructions:
      "Listen carefully to pronunciation and answer all questions. Each question carries 2 marks.",
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          "B is a consonant sound, while a, e, and o are vowel sounds.",
        points: 2,
      },
      {
        id: "q3",
      ...
      },
      {
        ...
        correctAnswer: "False",
        explanation:
          "Letters are symbols that represent sounds, but they are not sounds themselves.",
        points: 2,
      },
      {
        id: "q8",
        ...
        correctAnswer: 1,
        explanation:
          "Vowel sounds are produced by allowing air to flow freely through the mouth without obstruction.",
        points: 2,
      },
    ],
    attempts: [],
  },
  {
    ...
    isAvailable: true,
    instructions:
      "Answer all questions about living and non-living things. Think carefully about the characteristics of life.",
    ...
    questions: [
      {
        ...
        correctAnswer: 2,
        explanation:
          "Living things are made of cells, not metal. Metal is a characteristic of non-living things.",
        points: 2,
      },
      {
        id: "q2",
        ...
        correctAnswer: 3,
        explanation:
          "Living things need air (oxygen), water, and food to survive and carry out life processes.",
        points: 2,
      },
      {
        id: "q3",
        ...
        correctAnswer: "True",
        explanation:
          "Plants are living things because they grow, reproduce, respond to stimuli, and carry out other life processes.",
        points: 2,
      },
      {
        id: "q4",
        ...
        correctAnswer: 2,
        explanation:
          "Only a dog can reproduce (have offspring). This is a characteristic of living things.",
        points: 2,
      },
      {
        id: "q5",
        ...
        explanation:
          "Living things respond to changes in their environment. This is called response to stimuli.",
        points: 2,
      },
      {
        id: "q6",
        ...
        correctAnswer: 0,
        explanation:
          "Excretion is the process by which living things remove waste products from their bodies.",
        points: 2,
      },
      {
        id: "q7",
        ...
        correctAnswer: "False",
        explanation:
          "Not all living things can move from place to place (like plants), but they can still show movement (like growing toward light).",
        points: 2,
      },
      {
        id: "q8",
        ...
        options: [
          ...
          "A puppy becoming a dog",
          "Ice melting",
          "A car rusting",
        ],
        correctAnswer: 1,
        explanation:
          "A puppy growing into a dog is biological growth, a characteristic of living things.",
        points: 2,
      },
      {
        id: "q9",
      ...
      },
      {
        ...
        type: "fill-blank",
        question:
          "The process by which living things make more of their kind is called _______.",
      ...
      },
      {
        ...
        correctAnswer: "False",
        explanation:
          "Although fire appears to grow and move, it is not alive because it does not have cells, cannot reproduce, or carry out other life processes.",
        points: 2,
      },
      {
        id: "q12",
        type: "multiple-choice",
        question:
          "Which life process involves taking in oxygen and releasing carbon dioxide?",
  ...
  },
  {
    ...
    description:
      "Comprehensive test covering topics from the first half of Term 1",
    subjectId: "mathematics",
    classLevel: "JSS1",
    term: "Term1",
    scope: "midterm",
    ...
    instructions:
      "This is your midterm examination. You have 60 minutes to complete 20 questions. Read each question carefully and show your working where necessary.",
...
export function getQuizzesByClassAndTerm(
  classLevel: string,
  term: string,
): Quiz[] {
  return mockQuizzes.filter(
    (quiz) => quiz.classLevel === classLevel && quiz.term === term,
  );
}
