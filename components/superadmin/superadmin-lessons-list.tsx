...
interface SuperadminLessonCardProps {
  lesson: Lesson;
  onSelect?: (lessonId: number) => void;
  onTrashSuccess?: (lessonId: number) => void;
}

function SuperadminLessonCard({
  lesson,
  onSelect,
  onTrashSuccess,
}: SuperadminLessonCardProps) {
...
export function SuperadminLessonsList({
  onLessonSelect,
  onTrashSuccess,
  showPagination = true,
}: SuperadminLessonsListProps) {
  const {
    lessons,
    isLoadingLessons,
    error,
