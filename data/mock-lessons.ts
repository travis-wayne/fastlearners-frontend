...
export const mockLessons: Lesson[] = [
  // Mathematics JSS1 Term1 Lessons
  {
    ...
    duration: 40,
    content: {
      introduction: 'Whole numbers are the numbers we use for counting and ordering. They include 0, 1, 2, 3, 4, 5, and so on.',
      objectives: [
      ...
      materials: ['Number charts', 'Counting objects', 'Whiteboard', 'Textbook'],
      activities: [
      ...
      summary: 'Whole numbers are non-negative integers starting from 0. They are used in counting and basic arithmetic operations.',
      homework: 'Practice writing numbers 1-50 and arrange the following numbers in ascending order: 25, 3, 17, 8, 42, 1, 33'
    },
    media: [
      {
        type: 'video',
  ...
  },
  {
    ...
    description: 'Understanding the place value system and representing numbers',
    duration: 45,
    content: {
      introduction: 'Place value tells us the value of each digit in a number based on its position.',
      objectives: [
      ...
      summary: 'Place value system helps us understand the value of digits based on their position in a number.',
      homework: 'Write the following numbers in expanded form: 247, 503, 1,892, 4,056'
    },
    media: [
      {
        type: 'video',
  ...
  // English JSS1 Term1 Lessons
  {
    ...
    duration: 40,
    content: {
      introduction: 'Speech sounds are the basic units of spoken language. In English, we have vowels and consonants.',
      objectives: [
      ...
      materials: ['Audio recordings', 'Phonetic charts', 'Mirror for mouth observation'],
      activities: [
      ...
      summary: 'English has vowel sounds (a, e, i, o, u) and consonant sounds. Correct pronunciation is important for effective communication.',
      homework: 'Practice pronouncing the 5 vowel sounds and record yourself saying 10 words with each vowel sound'
    },
    media: [
      {
        type: 'audio',
  ...
  // Basic Science JSS1 Term1 Lessons
  {
    ...
    description: 'Learning about the features that distinguish living things from non-living things',
    duration: 45,
    content: {
      introduction: 'Living things have certain characteristics that make them different from non-living things.',
      objectives: [
      ...
      materials: ['Pictures of living and non-living things', 'Plants', 'Chart paper'],
      activities: [
      ...
      summary: 'Living things show characteristics like movement, reproduction, growth, respiration, nutrition, excretion, and response to stimuli.',
      homework: 'Make a list of 10 living things and 10 non-living things you can find at home. Explain why each living thing is considered alive.'
    },
    media: [
      {
        type: 'video',
  ...
  // Add some more lessons for variety
  {
    ...
    duration: 50,
    content: {
      introduction: 'Addition is combining two or more numbers to get a total or sum.',
      objectives: [
      ...
      summary: 'Addition combines numbers to find their total. We can add using objects, number lines, or the column method.',
      homework: 'Complete addition worksheet with 20 problems including word problems'
    },
    media: [
      {
        type: 'video',
  ...
  },
  {
    ...
    duration: 45,
    content: {
      introduction: 'Reading comprehension involves understanding what we read and being able to answer questions about it.',
      objectives: [
      ...
      summary: 'Good reading comprehension requires understanding vocabulary, identifying main ideas, and making connections.',
      homework: 'Read the assigned story and answer the comprehension questions. Look up 5 new words in the dictionary.'
    },
    media: [
      {
        type: 'document',
...
export function getLessonsByClassAndTerm(classLevel: string, term: string): Lesson[] {
  return mockLessons.filter(lesson => 
    lesson.classLevel === classLevel && lesson.term === term
  );
}
...
export function getInProgressLessons(): Lesson[] {
  return mockLessons.filter(lesson => 
    !lesson.progress.completed && lesson.progress.timeSpent > 0
  );
}
