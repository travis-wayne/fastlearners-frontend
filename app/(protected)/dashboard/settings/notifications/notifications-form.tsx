      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How much do you want to be disturbed?
            </CardDescription>
          </CardHeader>
          <CardContent>
            <FormField
              ...
              render={({ field }) => (
                <div className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Receive emails about your account activity and essential
                      updates.
                    </FormDescription>
                  </div>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      You can manage specific mobile notifications in the mobile
                      app settings.
                    </FormDescription>
                  </div>
                </FormItem>
