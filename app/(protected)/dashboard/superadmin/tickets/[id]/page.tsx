          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-6 pt-6 border-t">
                <p className="text-muted-foreground font-medium mb-2">Description</p>
                <p className="whitespace-pre-wrap">{ticket.description}</p>
              </div>

              {ticket.closed_by && (
                <div className="mt-6 pt-6 border-t">
                  <p className="text-muted-foreground font-medium mb-1">Closed By</p>
            ...
            <CardContent className="space-y-4">
              {assignments.length > 0 && (
                <div className="space-y-3 mb-4">
                  ...
                  {assignments.map(a => (
                    <div key={a.id} className="flex items-center justify-between p-2 text-sm border rounded-md">
                      <div>
