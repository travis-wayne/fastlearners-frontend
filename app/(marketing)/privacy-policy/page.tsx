      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            Fastlearners Limited (“Fastlearners”, “we”, “our”, or “us”) provides
            digital learning tools and educational services to students,
            parents/guardians, teachers, and institutions across Nigeria, Ghana,
          ...
          <p className="leading-relaxed text-muted-foreground">
            We encourage parents and guardians of children under the age of 18
            to review our Children&apos;s Data Protection Policy to understand
            how we safeguard the privacy of our younger users.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="text-muted-foreground">
              As an educational platform, we collect limited personal data from
              children under 18 for the purpose of personalising their learning
              journey. This is only done with verifiable parental/guardian
              consent or supervision.
            </p>
          </div>

          <p className="leading-relaxed text-muted-foreground">
            We do not collect sensitive personal data (e.g., biometric data,
            genetic data, or political opinions) unless strictly necessary for
            specific features and with your explicit consent.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
            <li>
              ...
              — to provide access to the Platform and educational services.
            </li>
            <li>
              <span className="font-medium text-foreground">
                Legitimate interests
              </span>{" "}
              — to improve services, personalise learning, conduct analytics,
              and ensure security.
            </li>
            <li>
              <span className="font-medium text-foreground">Consent</span> —
              where required, especially for children&apos;s data, direct
              marketing, or optional features.
            </li>
            <li>
              <span className="font-medium text-foreground">
                Legal obligation
          ...
          <p className="leading-relaxed text-muted-foreground">
            For children under the age of 18, we rely on parental or guardian
            consent in accordance with Section 31 of the NDPA and GAID 2025.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
            ...
            <li>
              To detect and prevent fraud, cheating, or misuse of the Platform
            </li>
            <li>To comply with regulatory obligations</li>
          </ul>
          <p className="leading-relaxed text-muted-foreground">
            We do not sell, trade, rent, or commercially exploit your personal
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            Protecting the privacy of children is our priority. We collect
            personal data from users under the age of 18 only with the express
          ...
          <p className="leading-relaxed text-muted-foreground">
            For more information, please see our dedicated{" "}
            <a
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            We may share your data with the following categories of third
            parties:
          </p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            ...
            <li>
              Educational partners or institutions (where you have authorised
              sharing)
            </li>
          </ul>
          <p className="leading-relaxed text-muted-foreground">
            All third parties are required to sign binding Data Processing
            Agreements (DPAs) that comply with the{" "}
            <span className="font-medium text-foreground">NDPA</span>. We do not
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            To provide our services, your personal data may be stored or
            processed in countries outside of Nigeria. When transferring data
          ...
          <p className="leading-relaxed text-muted-foreground">
            We only use cloud providers and data centres that meet the security
            standards approved by the Nigeria Data Protection Commission (NDPC).
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
            <li>
              ...
              retained for the duration of your relationship with us
            </li>
            <li>
              <span className="font-medium text-foreground">
                Inactive accounts:
              </span>{" "}
              archived or deleted after 24 months of inactivity
            </li>
            <li>
              <span className="font-medium text-foreground">
                Children&apos;s data:
              </span>{" "}
              deleted upon reaching adulthood or upon parental request (subject
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Under the NDPA, you have several rights regarding your personal
            data:
          </p>
          <ul className="list-disc space-y-1 pl-6 text-muted-foreground">
          ...
          <p className="leading-relaxed text-muted-foreground">
            ...
            below. We will respond within one (1) month (or as required by law).
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            However, no system is completely secure. We encourage you to keep
            your login credentials confidential and notify us immediately of any
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-muted-foreground">
            ...
            compliance with the NDPA and handle any privacy-related enquiries.
          </p>
          <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
            <p className="mb-2 font-medium text-foreground">
              DPO: Oladele Joshua O.
            </p>
